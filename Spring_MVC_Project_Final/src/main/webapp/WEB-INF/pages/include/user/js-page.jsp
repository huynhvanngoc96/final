<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <script src="<c:url value="resources/vendors/bootstrap-datepicker/bootstrap-datetimepicker.min.js"/>"></script>
        <script src="<c:url value="resources/vendors/nice-select/js/jquery.nice-select.js"/>"></script>
        <script src="<c:url value="resources/js/mail-script.js"/>"></script>
