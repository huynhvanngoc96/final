...
<link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" rel="stylesheet" type="text/css" />
	...
	<!-- icons -->	
    <link href="<c:url value="resources-management/assets/plugins/simple-line-icons/simple-line-icons.min.css"/>" 
    rel="stylesheet" type="text/css" />
    <link href="<c:url value="resources-management/assets/plugins/font-awesome/css/font-awesome.min.css"/>" 
    rel="stylesheet" type="text/css"/>
    
	<!--bootstrap -->	
	<link href="<c:url value="resources-management/assets/plugins/bootstrap/css/bootstrap.min.css"/>" rel="stylesheet" type="text/css" />
	<link href="<c:url value="resources-management/assets/plugins/summernote/summernote.css"/>" rel="stylesheet">
	
	<!-- morris chart -->
    <link href="<c:url value="resources-management/assets/plugins/morris/morris.css"/>" rel="stylesheet" type="text/css" />
